package com.gemini.boot.framework.admin.common.aop;
...
import com.gemini.boot.framework.common.web.utils.IPUtils;
...
public class SysLogAspect {
    ...
    @Pointcut("@annotation(com.gemini.boot.framework.admin.common.annotation.SysLog)")
    public void sysLog() {
